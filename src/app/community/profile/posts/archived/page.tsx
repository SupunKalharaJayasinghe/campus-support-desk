...
export default function CommunityProfileArchivedPostsPage() {
  ...
  const archivedPosts = useMemo(
    () => (posts ?? []).filter((post) => isOlderThanDays(post.createdAt, 7)),
    [posts]
  );
    ...
    <main className="min-h-screen bg-slate-50 px-3 py-6 sm:px-6">
      <div className="mx-auto w-full max-w-5xl">
        ...
        {posts === null ? (
          ...
          <Card className="rounded-2xl border border-blue-100 bg-white p-4 text-sm text-slate-600 shadow-none">
            No archived posts older than 7 days yet.
          </Card>
        ) : (
      ...
      {postDeleteConfirm && (
        ...
        >
          ...
          <div
            ...
            role="dialog"
            aria-modal="true"
            aria-labelledby="archived-posts-delete-confirm-title"
          >
            <h2
              id="archived-posts-delete-confirm-title"

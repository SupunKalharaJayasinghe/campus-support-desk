...
export default function AdminShell({ children }: { children: React.ReactNode }) {
  ...
  return (
    <AdminContextProvider>
      <div className="admin-experience h-dvh overflow-hidden bg-bg">
        <div className="admin-shell h-full">
          <div className="admin-workspace flex h-full overflow-hidden">
            <AdminSidebar
              collapsed={sidebarCollapsed}
              onCollapsedChange={setSidebarCollapsed}
            />

            <div className="admin-main-column flex h-full min-w-0 flex-1 flex-col overflow-hidden">
              <AdminTopbar />
